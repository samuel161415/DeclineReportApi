...
async function processLineByLine(file,report,folderToRead,total,eachTotal) {
  ...
  if(!(atmName in report)){
    ...
    allFileContents.split(/\r?\n/).forEach(line =>  {
     ...
     else if(line.toString()===DeclineCondtitions[11]){
    ...
    //console.log('atmName',atmName,'report',report);
